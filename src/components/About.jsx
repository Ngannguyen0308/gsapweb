...
export default function About() {
    ...
    return (
        <div id='about' className='min-h-screen w-screen'>
            <div className='relative mb-8 mt-36 flex flex-col intems-center gap-5'>
                <h2 className='font-general text-sm uppercase md:text-[16px] items-center justify-center flex'>Welcome to Zentry</h2>
