...
export default function Hero() {
    // make video player in a center when click on it
            ...
            <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
                ...
                <div>
                    ...
                    <video
                        ...
                        autoPlay
                        loop
                        muted className='absolute left-0 top-0 size-full object-cover object-center'
                        onLoadedData={handleVideoLoaded}
                    />
                </div>
                ...
                <div className='absolute left-0 top-0 z-40 size-full'>
                    <div className='mt-24 px-5 sm:px-100'>
                        <h1 className='special-font hero-heading text-blue-100'>Redefi<b>n</b>e</h1>
                        <p className='mb-5 max-w-64 font-robert-regular text-blue-100'>Enter the Metagame Layer <br />Unleash the Play Economy</p>
                        <Button id="watch-trailer" title="watch trailer" leftIcon={<TiLocation />} containerClass=" flex-center gap-1" />
                    </div>
                </div>
            </div>
